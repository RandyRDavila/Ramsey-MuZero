...
def _trainer_cmd(base_args: List[str]) -> List[str]:
    py = sys.executable
    # Always prefer the package trainer module
    ...
    raise FileNotFoundError(
        "No trainer entry point found. Expected module 'ramsey.main' or a 'main.py' at repo root."
    )
...
def main() -> None:
    ...
    while True:
        ...
        try:
            ...
            console.print("\n[cyan]Cancelled by user.[/cyan]")
        except Exception as e:
            # Show the full traceback so “nothing happens” becomes debuggable
